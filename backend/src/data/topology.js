/**
 * 仿真系统拓扑数据
 * 数据来源：PRD.md 第 4.1 节（场景内容）
 * 描述模拟器、服务器（Master/Agent）及连接关系。
 */
...
/**
 * 服务器列表（PRD 4.1.2）
 * 主从模式：第一台为 Master + Agent，其余为 Agent。
 * 每个 Agent 连接一台模拟器。
 */
...
export const connections = [
  {
    ...
    color: '#00ccff',
    arcH: 1.8,
    description: 'Master 内置 Agent 与机动车模拟器之间的数据同步流。'
  },
  {
    id: 'conn-1',
    type: 'agent-to-sim',
    ...
    color: '#00ccff',
    arcH: 1.8,
    description: 'Agent 1 与助动车模拟器之间的数据同步流。'
  },
  {
    id: 'conn-2',
    type: 'agent-to-sim',
    ...
    color: '#00ccff',
    arcH: 1.8,
    description: 'Agent 2 与自行车模拟器之间的数据同步流。'
  }
];

/** 完整拓扑 */
export const topology = { simulators, servers, connections };
